  ...
  return (
    <div className="min-h-screen p-4 md:p-6 lg:p-8 font-sans">
      ...
      <main className="grid grid-cols-1 xl:grid-cols-4 gap-6">
        ...
        {/* Left Column: Analysis Engine (Prioritized, Wider) */}
        <section className="xl:col-span-3 space-y-6">
          <AnalysisEngine />
          
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
             {/* Dynamic Sentiment Feed grounded by Search */}
             <SentimentFeed />
        ...
        {/* Right Column: Market Trends (Summary sidebar) */}
      ...
      <footer className="mt-12 text-center text-xs text-slate-600 border-t border-slate-800 pt-6">
        ...
        <p className="max-w-4xl mx-auto">
          ...
          The analysis provided by this application is generated by AI based on historical technical patterns (MACD), social sentiment, and provided screenshots. 
          It does not guarantee future price movements. Always conduct your own research and risk management. 
          Real-time data grounding is used to enhance sentiment analysis but may have latency.
        </p>
        <p className="mt-4">
